...
sac_file_path2 = 'runs-txt/sac_different_buffer_size/sac-2023-12-13_00-22-48-buf14.txt'
sac_file_path3 = 'runs-txt/sac_different_buffer_size/sac-2023-12-13_00-22-57-buf12.txt'
...
plt.title('SAC - Average Return vs Number of Steps for Different Buffer Sizes')
